...
describe('derived client types', () => {
  ...
  describe('BaseClient', () => {
    ...
    it('does not have tx-only modules', () => {
      expectTypeOf<BaseClient>().not.toHaveProperty('ibc')
      expectTypeOf<BaseClient>().not.toHaveProperty('ibcCore')
      expectTypeOf<BaseClient>().not.toHaveProperty('authz')
      expectTypeOf<BaseClient>().not.toHaveProperty('feegrant')
    })
  })
